...
// }
//
// const test2 = document.getElementById('us')
// test2.addEventListener('mouseenter', test)

const test3 = document.getElementsByClassName('region-item')
...
for (i = 0; i <= test3.length; i++) {
    test3[i].addEventListener('mouseenter', show)
    test3[i].addEventListener('mouseleave', hide)

}
function showAddedInfo(e) {
    const x = e.clientX
    const y = e.clientY
    console.log(x,y)
